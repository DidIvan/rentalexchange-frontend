...
var successLoginFunction1 = function (userName, password) {
    isAuthenticate = true;
...
var loginSend = function (userName, password, successLoginFunction1) {
    var dataJson = {
        'email': userName,
        'password': password
    };
...
module.exports.errorLoginFunction = errorLoginFunction;