...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ActivationContainer = React.createFactory(__webpack_require__(156));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Activation = React.createClass({displayName: "Activation",
	    getInitialState: function () {
	        return {
	            password: '',
	            password_1: '',
	    ...
	    , render: function () {
	        ...
	        if (!this.state.isActivationSuccess) {
	            activationComp =
	                React.createElement("form", {className: "registrationForm", onSubmit: this.handleSubmit}, 
	                    React.createElement("h5", {className: "header center blue-text text-lighten-1"}, "Активация учетной записи"), 

	                    React.createElement("div", {className: "row"}, 
	                        React.createElement("div", {className: "col s3"}, React.createElement("p", null)), 
	                        React.createElement("div", {className: "input-field col s6"}, 
	                            React.createElement("input", {value: this.state.passwowrd, onChange: this.handlePasswordChange, id: "password", 
	                                   type: "password", className: "validate"}), 
	                            React.createElement("label", {className: "active", for: "password"}, "Новый пароль")
	                        ), 
	                        React.createElement("div", {className: "col s3"}, React.createElement("p", {className: "red-text"}, this.state.errMessage))
	                    ), 
	                    React.createElement("div", {className: "row"}, 
	                        React.createElement("div", {className: "col s3"}, React.createElement("p", null)), 
	                        React.createElement("div", {className: "input-field col s6"}, 
	                            React.createElement("input", {value: this.state.password_1, onChange: this.handlePasswordChange_1, id: "password_1", 
	                                   type: "password", className: "validate"}), 
	                            React.createElement("label", {className: "active", for: "password_1"}, "Введите новый пароль еще раз")
	                        )
	                    ), 
	                    React.createElement("div", {className: "row"}, 
	                        React.createElement("div", {className: "col s3"}, React.createElement("p", null)), 
	                        React.createElement("div", {className: "col l9 s12"}, 
	                            React.createElement("p", null, React.createElement("img", {src: "../img/captcha.jpg", alt: "captcha"}))
	                        )
	                    ), 
	                    React.createElement("div", {className: "row"}, 
	                        React.createElement("div", {className: "col s6"}, React.createElement("p", null)), 
	                        React.createElement("button", {type: "submit", className: "btn waves-effect light-blue lighten-1", value: "Registration"}, "Активировать"
	                        )
	                    )
	                );
	        } else {
	            activationComp =
	                React.createElement("div", null, 
	                    React.createElement("h5", {className: "header center blue-text text-lighten-1"}, "На указанный email отправлено письмо" + ' ' +
	                        "активации")
	                );
	        }
