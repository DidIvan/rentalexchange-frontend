...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var contentHtml = ReactDOMServer.renderToString(React.createElement(Content, data));
	        /**
	         ...
	         */
	        var initScript = 'error(' + JSON.stringify(data).replace(/script/g, 'scr"+"ipt') + ')';
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('link', { href: 'http://fonts.googleapis.com/icon?family=Material+Icons', rel: 'stylesheet' }),
	                React.createElement('link', { type: 'text/css', rel: 'stylesheet', href: 'css/materialize.min.css', media: 'screen,projection' }),
	                React.createElement('script', { src: 'http://fb.me/react-0.12.2.js' }),
	                React.createElement('script', { src: 'http://fb.me/JSXTransformer-0.12.2.js' }),
	                React.createElement('script', { src: 'https://code.jquery.com/jquery-2.1.1.min.js' }),
	                React.createElement('meta', { name: 'viewport', content: 'width=device-width, initial-scale=1.0' }),
	                React.createElement('link', { rel: 'stylesheet', type: 'text/css', href: '/css/style-markup.css' }),
	                React.createElement('link', { href: 'css/style.css', type: 'text/css', rel: 'stylesheet', media: 'screen,projection' }),
	                React.createElement('script', { type: 'text/javascript', src: 'javascripts/libs/jquery.js' }),
	                React.createElement('script', { type: 'text/javascript', src: 'javascripts/libs/materialize.min.js' })
	            ),
	            React.createElement(
	                'body',
	                { className: 'element' },
	                React.createElement('div', { id: 'content', className: 'container', dangerouslySetInnerHTML: { __html: contentHtml } }),
	                React.createElement('script', { src: '/error.js' }),
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("img", { src: "img/landingPage/logo.png", className: "valign", alt: "logo" })
	                )
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var authenticator = __webpack_require__(163);
	...
	var Auth = React.createClass({
	    ...
	    handleLoginChange: function handleLoginChange(event) {
	    ...
	    handleSubmitL: function handleSubmitL(event) {
	        event.preventDefault();
	    ...
	    handleSubmitR: function handleSubmitR(event) {
	        event.preventDefault();
	    ...
	    handlePasswordForgot: function handlePasswordForgot(event) {
	        this.setState({ isForgotForm: true });
	    },
	    defaultForgotForm: function defaultForgotForm(event) {
	    ...
	    render: function render() {
	        ...
	        if (!this.state.isLoginForm) {
	            loginForm = React.createElement(
	                'form',
	                { claassName: 'login-form', onSubmit: this.handleSubmitL },
	                React.createElement(
	                    'div',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('input', { value: this.state.login, id: 'email', type: 'email',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('input', { value: this.state.password, id: 'icon_password', type: 'password',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'button',
	                            { className: 'btn waves-effect waves-light col s12', type: 'submit', name: 'action' },
	                            React.createElement('i', { className: 'mdi-action-lock-open' }),
	                            'Войти'
	                        )
	                    )
	                ),
	        ...
	        if (!this.state.isActivationSuccess) {
	            registrForm = React.createElement(
	                'form',
	                { claassName: 'login-form', onSubmit: this.handleSubmitR },
	                React.createElement(
	                    'div',
	                    { className: 'row center' },
	                    React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'p',
	                        { className: 'center' },
	                        'На этот e-mail мы отправим письмо для проверки корректностиуказанногоадреса. Вписьме будут содержаться инструкции по активации учётной записи пользователя с таким email.'
	                    )
	                ),
	                React.createElement(
	                    'div',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'button',
	                            { className: 'btn waves-effect waves-light col s12', type: 'submit',
	                                name: 'action' },
	        ...
	        if (!this.state.isForgotPassword) {
	            forgotForm = React.createElement(
	                'form',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'h5',
	                        null,
	                        'Восстановление доступа к персональному кабинету.'
	                    )
	                ),
	                React.createElement(
	                    'div',
	            ...
	            forgotForm = React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        ' отправлено письмо с ссылкой для восстановления доступа к персональному кабинету. Для перехода в кабинет перейдите по ссылке из письма.'
	                    )
	                )
	            );
	        }
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        'a',
	                                        { href: '#test1',
	                                            onClick: this.defaultForgotForm },
	                                        'Войти'
	                                    )
	                                ),
	                                React.createElement(
...
/***/ function(module, exports) {
	...
	var loginSend = function (userName, password) {
	    var dataJson = {
	        'email': userName,
	        'password': password
	    };
	...
	var getSecuredResourcesSend = function (url, successFunction, errorFunction) {
	    return basicAuthGET(url, headerToken, successFunction, errorFunction);
	};
	var postSecuredRecources = function (url, dataJson, successFunction, errorFunction) {
	 ...
	 *
	 */
	module.exports.login = loginSend;
	...
	module.exports.getSecuredResources = getSecuredResourcesSend;
	/**
	...
	module.exports.postSecuredRecources = postSecuredRecources;
	/**
	 * This variable provide current authenticate status.
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    Category = __webpack_require__(165);
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement("img", { src: "img/landingPage/logo.png", alt: "logo" })
	                    )
	                ),
	                React.createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoodsCategory = __webpack_require__(164);
	var Footer = __webpack_require__(166);
	var BestGoods = __webpack_require__(167);
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    "div",
	                                    { "class": "circles" },
	                                    React.createElement("div", { id: "close-circle", "class": "circle" }),
	                                    React.createElement("div", { id: "minimize-circle", "class": "circle" }),
	                                    React.createElement("div", { id: "maximize-circle", "class": "circle" })
	                                )
	                            ),
	                            React.createElement(
	                                "div",
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        "div",
	                                        { id: "site-layout-example-top", "class": "col s12" },
	                                        React.createElement(
	                                            "p",
	                                            { "class": "flat-text-logo center white-text caption-uppercase" },
	                                            "Sorry but we couldn’t find this page :("
	                                        )
	                                    ),
	                                    React.createElement(
	                                        "div",
	                                        { id: "site-layout-example-right", "class": "col s12 m12 l12" },
	                                        React.createElement(
	                                            "div",
	                                            { "class": "row center" },
	                                            React.createElement(
	                                                "h1",
	                                                { "class": "text-long-shadow col s12" },
	                                                "404"
	                                            )
	                                        ),
	                                        React.createElement(
	                                            ...
	                                            React.createElement(
	                                                "p",
	                                                { "class": "center white-text col s12" },
	                                            ...
	                                            React.createElement(
	                                                ...
	                                                React.createElement(
	                                                    "button",
	                                                    { onclick: "goBack()", "class": "btn waves-effect waves-light" },
	                                                    "Back"
	                                                ),
	                                                " ",
	                                                React.createElement(
	                                                    "a",
	                                                    { href: "index.html", "class": "btn waves-effect waves-light" },
	                                                    "Homepage"
	                                                )
	                                            ),
