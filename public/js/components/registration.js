...
var RegistrationForm = React.createClass({
    ...
    , handleEmailChange: function (e) {
        ...
        if  (this.validateEmail(this.state.email)) {
            document.getElementById('icon_email_reg').style.color = 'green';
        ...
        return (
            <form className="registrationForm" onSubmit={this.handleSubmit}>
                <div className="row">
                    ...
                    <div className="col l3 s12"><i id="icon_email_reg"
                                                   className="medium material-icons">{this.state.validIcon}</i></div>
                    <div className="col l9 s12">
                        <p><img src="../img/captcha.jpg" alt="captcha"></img></p>
                    </div>
                    <div className="col l9 s12">
                        <button className="btn waves-effect light-blue lighten-1" type="submit" value="Registration">
                            Зарегистрировать
